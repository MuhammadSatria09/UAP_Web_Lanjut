...
<h1 class="text-center text-2xl font-bold text-gray-800">All Catalouge</h1>
</div>

<!-- Tab Menu -->
<div class="flex flex-wrap items-center  overflow-x-auto overflow-y-hidden py-10 justify-center   bg-white text-gray-800">
	<a rel="noopener noreferrer" href="/catalogue/create" class="flex items-center flex-shrink-0 px-5 py-3 space-x-2  text-gray-600">
		<span>+ Add Catalouge</span>
	</a>
</div>
  ...
  <?php foreach ($katalog as $katalog){
    ...
    <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
      <a href="#">
        ...
        <div class="mt-1 p-2">
          <h2 class="text-slate-700"><?= $katalog['nama_produk']?></h2>
          <p class="mt-1 text-sm text-slate-400">SewSense</p>

          <div class="mt-3 flex items-end justify-between">
            <p class="text-lg font-bold text-blue-500">Rp <?=number_format($katalog['harga'],0,',','.')?></p>
            
            <div class="flex items-center rounded-lg bg-blue-500 px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
                <a href="/catalogue/<?= $katalog['id']?>"><i class="fa fa-solid fa-pen"></i></a>
            </div>
            <div class="flex items-center space-x-1.5 rounded-lg bg-red-500 px-4 py-1.5 text-white duration-100 hover:bg-red-600">
                <form action="<?= base_url('catalogue/' . $katalog['id']) ?>" method="POST">
