...
class Home extends BaseController
{
    public function index()
    {
        ...
        // Jika pengguna tidak memiliki grup yang diizinkan, Anda dapat mengarahkannya atau memberikan pesan akses ditolak.
        return redirect()->to('/login')->with('message', 'Akses ditolak.');
    }
